...
import me.coolmint.ngm.event.impl.EventFixVelocity;
import me.coolmint.ngm.event.impl.KeyEvent;
import me.coolmint.ngm.event.impl.EventPlayerJump;
import me.coolmint.ngm.event.impl.EventPlayerTravel;
import me.coolmint.ngm.features.settings.Setting;


public class Rotations extends Module {
    public Rotations() {
        super("Rotations", "", Module.Category.CLIENT, true, false, false);
    }

    private final Setting<MoveFix> moveFix = register(new Setting<>("MoveFix", MoveFix.Free));

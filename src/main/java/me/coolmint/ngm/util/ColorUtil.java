...
public class ColorUtil {
    ...
    public static Color rainbow(int delay) {
        ...
        return Color.getHSBColor((float) ((rainbowState %= 360.0) / 360.0), ClickGuiModule.getInstance().rainbowSaturation.getValue().floatValue() / 255.0f, ClickGuiModule.getInstance().rainbowBrightness.getValue().floatValue() / 255.0f);
    }
